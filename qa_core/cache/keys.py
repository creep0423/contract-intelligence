...
# Bump this value whenever retrieval candidate generation or final ranking semantics change.
# It prevents a deployment from serving Redis results produced by the previous algorithm.
RETRIEVAL_CACHE_SCHEMA_VERSION = "v2"
