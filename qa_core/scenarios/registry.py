...
class ScenarioRegistry:
    ...
    def resolve(self, scenario_id: str | None = None) -> ScenarioDefinition:
        ...
        if configured in ACTIVE_SCENARIO_IDS and configured in self.scenarios:
            return self.scenarios[configured]
        # 兜底行为：按排序后的第一个场景作为当前场景，保证单场景部署也正常工作
        return self.list_runtime_scenarios()[0]
    ...
    def as_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "scenarios": [scenario.as_dict(include_internal=True) for scenario in self.list_runtime_scenarios()],
        }
