...
from qa_core.prompts.profiles import (
    CATEGORY_PROMPT_PROFILES,
    CONTRACT_PROMPT_PROFILE,
...
def build_answer_prompt_profile(
    ...
    profile = (
        CONTRACT_PROMPT_PROFILE
        if scenario.scenario_id == "tender_contract_risk"
        else CATEGORY_PROMPT_PROFILES.get(question_category) or PROMPT_PROFILES.get(intent, DEFAULT_PROMPT_PROFILE)
    )
