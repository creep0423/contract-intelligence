...
from qa_core.contracts.prompts import CONTRACT_ANSWER_SYSTEM_PROMPT
...
CONTRACT_PROMPT_PROFILE = PromptProfile(
    name="contract_performance_answer",
    system_template=CONTRACT_ANSWER_SYSTEM_PROMPT,
    user_template=ANSWER_USER_TEMPLATE,
    reason="合同运行场景必须区分合同事实、风险判断和处理建议，并保持逐条可追溯。",
)
