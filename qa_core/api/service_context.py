...
RUNTIME_SCENARIO_ID = "tender_contract_risk"
CONTRACT_DATASET_PREFIX = "contract:"
...
class QueryServiceContext:
    ...
    def targets_contract_namespace(self) -> bool:
        """通用问答入口不得访问合同私有命名空间。"""
        return str(self.dataset_id or "").startswith(CONTRACT_DATASET_PREFIX) or self.source_filter == "contract"
